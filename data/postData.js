...
const posts = [ {
    ...
    id : 3,
    user_id :1,
    image_url : '/static/asset/48.jpg',
    description : "what else could the universe offer !!",
    date : new Date(),
    likes_count:8652,
    status : "no",
    comments_id: 100 
